...
def bot_response_function(user_message, chat_history):
    ...
    chatbot_prompt = f"""
    You are a knowledge extractor trying to understand the user's mind, their interactions, important people in their lives 

    respond to this journal entry:
      {user_message}
    ...
    * What did they do?
    * Where did they go? Assume house if nothing is listed
    * List some emotions they may have felt
    """
    ...
    prompt_llm(f"Extract one significant moment from {chatbot_prompt} to describe it to a painter")
...
if __name__ == "__main__":
    ...
    if args.option == 1:
        ...
        prompt = "write a post about the chilean hot-dog completo italiano in english"
        ...
        prompt = "Create an image of vancouver in water colour"
        ...
        text_prompt = "write a 3 line post about the protoss in starcraft for instagram"
